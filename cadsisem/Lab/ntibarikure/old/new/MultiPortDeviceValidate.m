function [ TwoPortDevices, Nto1Connections, ...
    OpenPorts, FrequencySweep, Symmetry, Topology, Error ] = ...
...
disp (['|  +--+> Displying device']);
if flag
    MultiPortDeviceDraw(TwoPortDevices, Nto1Connections, flag-1);
end
